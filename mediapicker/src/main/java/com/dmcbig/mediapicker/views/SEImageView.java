package com.dmcbig.mediapicker.views;
...
public class SEImageView extends ImageView {

    public SEImageView(Context context) {
        super(context);
    }

    public SEImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public SEImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
