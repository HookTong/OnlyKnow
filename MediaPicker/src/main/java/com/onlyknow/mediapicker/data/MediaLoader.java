...
public class MediaLoader extends LoaderM implements LoaderManager.LoaderCallbacks {
    ...
    public void onLoadFinished(Loader loader, Object o) {
        ...
        FolderBean allFolderBean = new FolderBean(mContext.getResources().getString(R.string.all_dir_name));
        folderBeans.add(allFolderBean);
        FolderBean allVideoDir = new FolderBean(mContext.getResources().getString(R.string.video_dir_name));
        folderBeans.add(allVideoDir);
        ...
        while (cursor.moveToNext()) {
            ...
            if (mediaType == 3) {
                allVideoDir.addMedias(mediaBean);
            }
