...
public class OKGanKResFragment extends OKBaseFragment implements OnRefreshListener, OnLoadMoreListener {
    ...
    public void onLoadMore(RefreshLayout refreshLayout) {
        if (OKNetUtil.isNet(getActivity())) {
            page++;
            mOKLoadGanKApi.requestGanKBeanList(OKLoadGanKApi.RES_URL + page, mOnCallBack);
        } else {
    ...
    public void onRefresh(RefreshLayout refreshLayout) {
        if (OKNetUtil.isNet(getActivity())) {
            mOKLoadGanKApi.requestGanKBeanList(OKLoadGanKApi.RES_URL + "1", mOnCallBack);
        } else {
