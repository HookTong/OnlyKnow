 ...
 */
public class OKGraduallyTextView extends EditText {
    ...
    public OKGraduallyTextView(Context context) {
        super(context);
        init();
    }


    public OKGraduallyTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }


    public OKGraduallyTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        valueAnimator.addUpdateListener(
                new ValueAnimator.AnimatorUpdateListener() {
                    ...
                    public void onAnimationUpdate(ValueAnimator animation) {
                        ...
                        OKGraduallyTextView.this.invalidate();
                    }
                });
    }
