...
public class OKDeletableEditText extends EditText {

    public OKDeletableEditText(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public OKDeletableEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public OKDeletableEditText(Context context) {
        super(context);
    }
