 ...
 */
public final class OKViewfinderView extends View {
    ...
    public OKViewfinderView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        resultPointColor = resources.getColor(R.color.md_pink_200);
    ...
    public void onDraw(Canvas canvas) {
        ...
        Rect frame = OKCameraManager.get().getFramingRect();
        if (frame == null) {
            return;
        }
