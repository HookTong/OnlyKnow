...
public class OKGanKAndroidFragment extends OKBaseFragment implements OnRefreshListener, OnLoadMoreListener {
    ...
    public void onLoadMore(RefreshLayout refreshLayout) {
        if (OKNetUtil.isNet(getActivity())) {
            page++;
            mOKLoadGanKApi.requestGanKBeanList(OKLoadGanKApi.ANDROID_URL + page, mOnCallBack);
        } else {
    ...
    public void onRefresh(RefreshLayout refreshLayout) {
        if (OKNetUtil.isNet(getActivity())) {
            mOKLoadGanKApi.requestGanKBeanList(OKLoadGanKApi.ANDROID_URL + "1", mOnCallBack);
        } else {
