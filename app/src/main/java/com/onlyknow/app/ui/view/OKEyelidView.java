 ...
 */
public class OKEyelidView extends View {
    ...
    public OKEyelidView(Context context) {
        super(context);
        init();
    }


    public OKEyelidView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }


    public OKEyelidView(Context context, AttributeSet attrs, int defStyleAttr) {
