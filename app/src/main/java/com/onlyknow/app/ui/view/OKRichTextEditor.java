 ...
 * 可编辑富文本
 */
public class OKRichTextEditor extends ScrollView {
    ...
    public OKRichTextEditor(Context context) {
        this(context, null);
    }

    public OKRichTextEditor(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OKRichTextEditor(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LinearLayout.LayoutParams firstEditParam = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,
    ...
    private void onImageCloseClick(View view) {
        ...
        if (editData.imagePath != null) {
            OKSDCardUtil.deleteFile(editData.imagePath);
        }
    ...
    public EditText createEditText(String hint, int paddingTop) {
        EditText editText = (EditText) inflater.inflate(R.layout.ok_rich_edit, null);
    ...
    private RelativeLayout createImageLayout() {
        RelativeLayout layout = (RelativeLayout) inflater.inflate(R.layout.ok_edit_image, null);
    ...
    public void addImageViewAtIndex(final int index, String imagePath) {
        ...
        OKDataImageView imageView = (OKDataImageView) imageLayout.findViewById(R.id.edit_imageView);
    ...
    public List<EditData> buildEditData() {
        ...
        for (int index = 0; index < num; index++) {
            ...
            if (itemView instanceof EditText) {
                ...
                OKDataImageView item = (OKDataImageView) itemView.findViewById(R.id.edit_imageView);
