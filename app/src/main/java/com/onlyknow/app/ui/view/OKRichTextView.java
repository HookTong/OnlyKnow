...
/**
 * Created by sendtion on 2016/6/24. 显示富文本
 */
public class OKRichTextView extends ScrollView {
    ...
    public OKRichTextView(Context context) {
        this(context, null);
    }

    public OKRichTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OKRichTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public TextView createTextView(String hint, int paddingTop) {
        TextView textView = (TextView) inflater.inflate(R.layout.ok_rich_text, null);
