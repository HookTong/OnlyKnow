...
final class OKCameraConfigurationManager {

	private static final String TAG = OKCameraConfigurationManager.class.getSimpleName();
	...
	OKCameraConfigurationManager(Context context) {
	...
	private void setFlash(Camera.Parameters parameters) {
		...
		// OKCameraManager.SDK_INT == Build.VERSION_CODES.CUPCAKE) {
		if (Build.MODEL.contains("Behold II") && OKCameraManager.SDK_INT == 3) { // 3
																				// =
																				// Cupcake
